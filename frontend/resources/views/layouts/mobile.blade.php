                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            ...
                            @endif
                        @else
                            <li class="nav-item dropdown py-4 px-2" style="background-color:#000" >
            
                               
                                    <a class="dropdown-item text-light" href="{{ route('payment.status') }}">
                                    <i class="fas fa-edit"></i> {{ __('Subscription') }}
                                    </a>
                                    <a class="dropdown-item text-light" href="{{ route('profile.index') }}">
                                    <i class="fas fa-user"></i> {{ __('Profile') }}
                                    </a>
                                    <a class="dropdown-item text-light" href="{{ route('change_password') }}">
