                    ...
                    <div class="col-lg-4 mb-3">
                        <div class="sign-user_card text-center">
                            ...
                            @if(file_exists( public_path().'/thumbnails/avatar-'. auth()->user()->id . '.png' ))
                                    <img src="{{ '/thumbnails/avatar-'. auth()->user()->id . '.png?id=' . microtime()  }}" class="rounded-circle img-fluid d-block mx-auto mb-3" alt="user">
                                    @else
                                    <img src="/images/user/user.jpg" class="rounded-circle img-fluid d-block mx-auto mb-3" alt="user">
                                    @endif
                            <h4 class="mb-3">{{ auth()->user()->name  }}</h4>
                            <p>{!! nl2br(e($profile->address)) !!}</p>
                            <a href="{{ route('profile.edit',  auth()->user()->id  ) }}" class="edit-icon text-primary">Edit</a>
                        </div>
                    </div>
                    <div class="col-lg-8">
                        <div class="sign-user_card">
                            ...
                            <div class="row align-items-center justify-content-between mb-3">
                                ...
                                <div class="col-md-4 text-md-right text-left">
                                    <a href="{{ route('change_password') }}" class="text-primary">Change</a>
                                </div>
                            </div>
                            {{--
                            <div class="row align-items-center justify-content-between mb-3">
